                ...
                <div class="card" style="border-color: cadetblue; border-width: 5px; width: 800px">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img src="../img/enrollment.png" width="150px" />
                                </center>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="Textbox2" runat="server" placeholder="dd-mm-yy"></asp:TextBox>
                                </div>
                            </div>         
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="Textbox3" runat="server" placeholder="example: 123 456 789"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col">
                             ...
                             <div class="form-group">
                                 <asp:DropDownList class="form-control" ID="DropDownList1" runat="server">
                                        ...
                                        <asp:ListItem Value="VN" Selected="True">Viet Nam</asp:ListItem>
                        ...
                        <center>
                            <span style="margin-top: 10px; margin-bottom: 10px" class="badge badge-pill badge-primary">Login Credentials</span>
                        </center>                       
                        <div class="row">
                            <div class="col">
